import { ScriptTagOptions } from "./ScriptTagOptions";
import { LinkTagOptions } from "./LinkTagOptions";

export function setTitle(value: string): void {
    document.title = value;
}

export function addOrUpdateStyle(content: string, type: string, key: string): void {
    let styleTag;
...
export function removeStyle(key: string): boolean {
...
export function addOrUpdateLink(options: LinkTagOptions): void {
...
export function removeLink(key: string): boolean {
...
export function addOrUpdateScript(options: ScriptTagOptions): Promise<unknown> {
...
export function removeScript(key: string): boolean {
...
function ensureAttribute(element: Element, attrName: string, attrValue: any): void {
